...
export default function (state = {}, action) {
  switch (action.type) {
    case DELETE_POST:
      // get rid of key and id of post we just deleted
      // doesn't modify existing state but returns a new state object with that particular post's id not present any more
    ...
    case FETCH_POST:
      ...
      // over time as user fetches more show routes, we'll fetch each additional post and add them to the overall state object
